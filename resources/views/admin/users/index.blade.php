                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ route('admin.users.create') }}">Создать</a></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                <a class="mr-3" href="{{ route('admin.users.show', $user->id) }}">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                                <a class="mr-3" href="{{ route('admin.users.edit', $user->id) }}">
