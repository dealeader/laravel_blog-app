                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Создания тега</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <form action="{{ route('admin.tags.store') }}" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="categoryTitle">Тег</label>
                                        <input type="text" name="title" class="form-control" id="categoryTitle" placeholder="Введите имя тега">
                                        @error('title')
